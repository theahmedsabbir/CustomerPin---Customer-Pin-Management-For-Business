    ...
    <div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt py-2" style="position: unset !important;">
            <div class="container">
                ...
                <a class="navbar-brand text-red" href="{{ route('visitor.home') }}">
                ...
                <div class="collapse navbar-collapse float-right" id="navbarCollapseAlt">
                    ...
                    <ul class="navbar-nav" style="margin-left:auto;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('visitor.pinCheck') }}" >Check Pin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('visitor.report') }}" >Report</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('visitor.editVisitor') }}" >Edit Info</a>
                        </li>
                        <li class="nav-item">
