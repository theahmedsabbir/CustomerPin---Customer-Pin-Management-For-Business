...
<div class="container">
    ...
    <div class="hk-pg-header align-items-top">
        <div>
            <h2 class="hk-pg-title font-weight-600 mb-10">Merchant Info</h2>
        ...
        <div class="col-xl-12">
            ...
            <div class="hk-row">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="{{ route('admin.updateMerchant', $user->id ) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_type" class="form-control" value="{{ $user->product_type }}">
                        </div>
