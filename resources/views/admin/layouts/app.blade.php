    ...
    <div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt py-2" style="position: unset !important;">
            <div class="container">
                ...
                <a class="navbar-brand text-red" href="{{ route('admin.home') }}">
                ...
                <div class="collapse navbar-collapse float-right" id="navbarCollapseAlt">
                    ...
                    <ul class="navbar-nav" style="margin-left:auto;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.merchants') }}" >Merchants</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.addMerchant') }}" >Add Merchants</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.pins', "all") }}" >Pin List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.editAdmin') }}" >Change Password</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="hk-footer-wrap container">
                <footer class="footer">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <p>Developed By Primex Systems</p>
                        </div>
                    </div>
                </footer>
            </div>
