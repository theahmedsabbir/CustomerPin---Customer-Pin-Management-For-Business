    ...
    <div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt py-2" style="position: unset !important;">
            <div class="container">
                ...
                <a class="navbar-brand text-red" href="{{ route('merchant.home') }}">
                ...
                <div class="collapse navbar-collapse float-right" id="navbarCollapseAlt">
                    ...
                    <ul class="navbar-nav" style="margin-left:auto;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.home') }}" >Home</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.visitors') }}" >Users</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.addVisitor') }}" >Add User</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.officers') }}" >Officers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.addOfficer') }}" >Add Officer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.pinGenerate') }}" >Generate Pin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.pins', "all") }}" >Pin List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.report') }}" >Report</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('merchant.editMerchant') }}" >Edit Info</a>
                        </li>
                        <li class="nav-item">
