        ...
        <div class="col-xl-12">
            <div class="hk-row">    
                ...
                <div class="col-lg-12">
                    ...
                    <a href="{{ route('merchant.visitorReport', $user->id) }}" class="ml-2">View Details</a>

                    </p>
                    <br>
                    <a href="{{ route('merchant.editVisitor', $user->id ) }}" class="btn btn-info pt-5">Edit Info</a>


                    <form action="{{ route('merchant.visitorLogin') }}" method="POST" class="d-inline">
                        @csrf
