...
<div class="container">
    ...
    <div class="hk-pg-header align-items-top">
        <div>
            <h2 class="hk-pg-title font-weight-600 mb-10">Merchant Login</h2>
        </div>
    </div>
    <!-- /Title -->
    <!-- Row -->
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-8">
                                        ...
                                        @if (Route::has('merchant.password.request'))
                                            <a class="btn btn-link mt-4" style="padding-left: 0 !important;" href="{{ route('merchant.password.request') }}">
